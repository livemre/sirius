    ...
    tab(tab)
{
    ...
    case SendingTab:
        ...
        break;
    case ReceivingTab:
        ui->labelExplanation->setText(tr("These are your Sirius addresses for receiving payments. You may want to give a different one to each sender so you can keep track of who is paying you."));
